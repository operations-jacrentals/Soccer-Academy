...
Load & readiness
- **RPE / session-RPE (sRPE)** — perceived effort × duration = simple training load.
- **Acute:Chronic Workload Ratio (ACWR)** — recent vs. rolling load; a spike flags injury risk.
- **Wellness / readiness surveys** — sleep, soreness, mood, fatigue.
...
- Endurance: **Yo-Yo Intermittent Recovery**, beep/bleep test, 30-15 IFT.
