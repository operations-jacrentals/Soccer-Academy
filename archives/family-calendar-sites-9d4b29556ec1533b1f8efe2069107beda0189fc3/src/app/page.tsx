...
const ROUTINE = {
  ...
  class1: { title: "Class 1", start: 9 * 60 + 30, end: 10 * 60 + 30, color: "#287a82", bullets: ["Taught by Laly"] },
  brunch: { title: "Brunch + break", start: 10 * 60 + 30, end: 11 * 60, color: "#b77a2c", bullets: ["Eat, reset, and breathe"] },
  class2: { title: "Class 2", start: 11 * 60, end: 12 * 60, color: "#287a82", bullets: ["Taught by Laly"] },
  soccer1: { title: "Soccer session 1", start: 12 * 60, end: 13 * 60, color: "#3c6fb0", bullets: ["Led by Jacob"] },
  class3: { title: "Class 3", start: 13 * 60, end: 14 * 60, color: "#287a82", bullets: ["Taught by Jacob"] },
...
function createInitialEvents(): CalendarEvent[] {
  ...
  events.push(
    ...
    },
    {
      ...
      color: "#6e7745",
      bullets: ["Jack", "End time needs confirmation"],
      people: ["Jack"],
      town: true,
      kind: "fixed",
      tentativeEnd: true,
    },
    {
      ...
      color: "#b45d49",
      bullets: ["Jack + Blue", "Before Gulf Coast — same town trip"],
      people: ["Jack", "Blue"],
      town: true,
      kind: "flexible",
    },
    {
      id: "gulf-tue",
      title: "Gulf Coast soccer",
      day: 1,
      start: 17 * 60 + 30,
      end: 19 * 60,
      color: "#287a82",
      bullets: ["Jack + Blue", "Gulf Coast club"],
      people: ["Jack", "Blue"],
      town: true,
      kind: "fixed",
    },
